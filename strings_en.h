...
const char HTTP_ROOT_MAIN[] PROGMEM = "<div style='margin:5%;float:left;width:90%'><h3>GENERAL</h3><hr/><fieldset><legend>Set the name of your NixieTap hotspot</legend>"
                                      "<input type='text' placeholder='NixieTap AP SSID'>&nbsp<input type='password' placeholder='NixieTap AP password'></fieldset>"
                                      "<h3>TIME AND DATE</h3><hr/><fieldset style='margin-bottom:1.5%;'><legend>Select what will be displayed on your NixieTap</legend>"
                                      "<div><input type='checkbox' id='show_time'><label for='show_time'>show time</label></div>"
                                      "<div><input type='checkbox' id='show_date'><label for='show_date'>show date</label></div>"
                                      "</fieldset><fieldset><legend>Select time/date source</legend><div style='margin-bottom:1%;'><input type='radio' id='man_td' name='td'>"
                                      "<label for='man_td'>manual</label>&nbsp<input type='time'><input type='date'></div><div><input type='radio' name='td' id='auto_td'>"
                                      "<label for='auto_td'>automatic</label>&nbsp<select name='country' id='country'><option value='1'>Country 1</option>"
                                      "<option value='2'>Country 2</option><option value='3'>Country 3</option></select></div>"
                                      "</fieldset><h3>TEMPERATURE</h3><hr/><div style='margin-bottom:1%;'><input type='checkbox' id='show_temp'><label for='show_temp'>show temperature</label>"
                                      ...
                                      "<input type='text' placeholder='API key'></fieldset><h3>CRYPTOCURRENCY</h3><hr/><div style='margin-bottom:1%'><input type='checkbox' id='show_crypto'>"
                                      "<label for='show_crypto'>show cryptocurrency price</label></div><fieldset><legend>Coinmarketcap API key</legend>"
                                      "<div>you can get your API key at <a href='https://coinmarketcap.com/api'>coinmarketcap.com/api</a></div><input type='text' placeholder='API key'></fieldset></div>";
