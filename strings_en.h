...
const char HTTP_ROOT_MAIN[] PROGMEM = "<div><hr class='hr_title'><h2 style='text-align: center; margin-bottom: 5%;'>CONFIGURATION PORTAL <blink>•</blink></h2>"
                                      ...
                                      "<input class='input-margin' type='text' name='SSID' maxlength='20' placeholder='NixieTap AP SSID'><input class='input-margin' type='password' maxlength='20' name='hotspot_password' placeholder='NixieTap AP password'>"
