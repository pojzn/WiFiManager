...
const char HTTP_ROOT_MAIN[] PROGMEM = "<div><hr class='hr_title'><h2 style='text-align: center; margin-bottom: 5%;'>CONFIGURATION PORTAL <blink>•</blink></h2>"
                                      ...
                                      "<input class='input-margin' type='text' name='SSID' maxlength='20' placeholder='NixieTap AP SSID'><input class='input-margin' type='password' minlength='8' maxlength='20' name='hotspot_password' placeholder='NixieTap AP password'>"
                                      ...
                                      "</div><div><input type='checkbox' name='enable24h' id='enable24h'><label for='enable24h'>24 hour format</label></div></div><div class='input-grp'><div>In manual mode, you set the time yourself.</div><div style='margin-top:1%; margin-bottom:1%'>In automatic mode, if Internet is available, Nixie Tap will ping an NTP time server for accurate time.</div>"
                                      ...
                                      "<label for='dst'>daylight savings time</label></div></div><h3>TEMPERATURE</h3><hr><div style='margin-top:1%; margin-bottom:1%;'><input type='checkbox' name='enableTemp' id='show_temp'><label for='show_temp'>show temperature</label>"
                                      ...
                                      "<div>Weather format</div><div><input type='radio' id='metric_wf' onclick='metric_wf()' name='weatherFormat' value='1'><label for='metric_wf'>metric</label><input type='radio' id='imperial_wf' onclick='imperial_wf()' name='weatherFormat' value='0'>"
                                      "<label for='imperial_wf'>imperial</label></div></div><h3>CRYPTOCURRENCY</h3><div style='margin-bottom:1%'><input type='checkbox' id='show_crypto' name='enableCrypto'><label for='show_crypto'>show cryptocurrency price</label>"
...
".input-grp{display: flex;flex-direction: column; align-items : flex-start; padding: 1% 0;} .input-margin{ margin-bottom : 1%;}"
