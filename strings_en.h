...
const char HTTP_ROOT_MAIN[] PROGMEM = "<div><hr class='hr_title'><h2 style='text-align: center; margin-bottom: 5%;'>CONFIGURATION PORTAL <blink>•</blink></h2>"
                                      ...
                                      "<label for='dst'>activate daylight savings time</label></div></div><h3>TEMPERATURE</h3><hr><div style='margin-top:1%; margin-bottom:1%;'><input type='checkbox' name='enableTemp' id='show_temp'><label for='show_temp'>show temperature</label>"
                                      ...
                                      "<div>Weather format</div><div><input type='radio' id='metric_wf' onclick='metric_wf()' name='weatherFormat' value='1'><label for='metric_wf'>°C</label><input type='radio' id='imperial_wf' onclick='imperial_wf()' name='weatherFormat' value='0'>"
                                      "<label for='imperial_wf'>°F</label></div></div><h3>CRYPTOCURRENCY</h3><div style='margin-bottom:1%'><input type='checkbox' id='show_crypto' name='enableCrypto'><label for='show_crypto'>show cryptocurrency price</label>"
